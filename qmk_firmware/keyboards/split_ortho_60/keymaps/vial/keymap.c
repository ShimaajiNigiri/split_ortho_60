...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
              KC_ESCAPE,            KC_1,            KC_2,            KC_3,
                   KC_4,            KC_5,          KC_TAB,            KC_Q,
                   KC_W,            KC_E,            KC_R,            KC_T,
           KC_CAPS_LOCK,            KC_A,            KC_S,            KC_D,
                   KC_F,            KC_G,   KC_LEFT_SHIFT,            KC_Z,
                   KC_X,            KC_C,            KC_V,            KC_B,
           KC_LEFT_CTRL,     KC_LEFT_GUI,           TO(3),     KC_LEFT_ALT,
        LT(1,KC_INTERNATIONAL_5),        KC_SPACE,            KC_6,            KC_7,
                   KC_8,            KC_9,        KC_MINUS,        KC_EQUAL,
                   KC_Y,            KC_U,            KC_I,            KC_O,
                   KC_P,       KC_DELETE,            KC_H,            KC_J,
                   KC_K,            KC_L,        KC_MINUS,     KC_KP_ENTER,
                   KC_N,            KC_M,        KC_COMMA,          KC_DOT,
                  KC_UP,  KC_RIGHT_SHIFT,    KC_BACKSPACE, LT(2,KC_INTERNATIONAL_4),
           KC_RIGHT_ALT,         KC_LEFT,         KC_DOWN,        KC_RIGHT
    ),
    [1] = LAYOUT(
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,           KC_F1,
                  KC_F2,           KC_F3,           KC_F4,           KC_F5,
         KC_TRANSPARENT,         KC_KP_1,         KC_KP_2,         KC_KP_3,
                KC_KP_4,         KC_KP_5,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,          KC_F11,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
                  KC_F6,           KC_F7,           KC_F8,           KC_F9,
                 KC_F10,  KC_TRANSPARENT,         KC_KP_6,         KC_KP_7,
    ...
    [2] = LAYOUT(
         ...
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  (QK_LSFT|KC_8),  (QK_LSFT|KC_9), KC_RIGHT_BRACKET,
           KC_BACKSLASH,  KC_TRANSPARENT,  KC_TRANSPARENT,  (QK_LSFT|KC_1),
        (QK_LSFT|KC_SLASH),        KC_MINUS, (QK_LSFT|KC_EQUAL),  KC_TRANSPARENT,
         KC_TRANSPARENT,    KC_SEMICOLON,        KC_QUOTE,  KC_TRANSPARENT,
    ...
    [3] = LAYOUT(
         ...
         KC_TRANSPARENT,  KC_TRANSPARENT,      KC_MS_BTN1,      KC_MS_BTN2,
             KC_MS_BTN3,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
                 KC_F24,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,
         KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT,  KC_TRANSPARENT
    )
};
